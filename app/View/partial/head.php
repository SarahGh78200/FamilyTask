    ...
    <div class="container-fluid">
        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0 text-white">
                ...
                <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-white" href="/"><i class="fa-solid fa-circle-plus"></i> Utilisateurs</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white" href="/"><i class="fa-solid fa-circle-plus"></i> Ajout sujet</a>
                    </li>
